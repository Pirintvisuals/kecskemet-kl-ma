"use client";
/**
 * Image Comparison — from 21st.dev (motion-primitives), retrieved via the
 * 21st MCP. Draggable/hover before-after slider.
 * Extended with `ImageComparisonPanel` (clips arbitrary children) so the
 * site can ship with styled placeholders until real photos arrive.
 */
...
/** Same clipping behaviour as ImageComparisonImage, but for arbitrary content. */
