<?php
/** Nyilvános katalógus fejléc. $pageTitle, $pageDesc, $ogImage, $accent állítható. */
require_once __DIR__ . '/catalog.php';

$pageTitle = $pageTitle ?? 'Klímamárkák – Kecskemét Klíma';
$pageDesc  = $pageDesc  ?? 'A telepített klímamárkák és típusaik Kecskeméten.';
$accent    = $accent    ?? '#0a6cd4';
$navLinks = [
    ...
    <div class="nav__inner">
        ...
        <nav class="nav__links">
            <?php foreach ($navLinks as [$href, $label]): ?>
                <a href="<?= e($href) ?>"<?= $href === '/klimak/' ? ' class="is-active"' : '' ?>><?= e($label) ?></a>
            <?php endforeach; ?>
        </nav>
